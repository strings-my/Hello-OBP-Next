        ...
        <div>
                        ...
                        <section className="login module">
                            ...
                            <form className="login-form" method="post">
                                ...
                                <div className="form-group">
                                    <input id="inUsername" type="text" className="form-control login-input" placeholder="Username" />
                                </div>
                                <div className="form-group">
                                    <input id="inEmail" type="text" className="form-control email-input" placeholder="Email" />
                                </div>
                                <div className="form-group">
                            ...
                            <div className="module-single-btn">
                                <button type="submit" className="btn btn-primary" onClick={() => doCreateAccount()} >Submit</button>
                            </div>
                        </section>
                    </div>
                </div>
            ...
            <style jsx>{`
                .login {
                    ...
                    .login-input, .password-input, .email-input {
                    padding-left: 44px;
